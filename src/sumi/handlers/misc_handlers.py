...
async def help_handler(update: Update, context: CallbackContext) -> None:
    ...
    help_text = """
Меня зовут Sumi. Я умею анализировать историю чата, где я состою. Я знаю следующие команды:
...
- /members_history — Покажу историю изменения участников чата. Работает только в маленьких чатах до 50 участников.
...
- /stop и /close — Закрою опрос. Необходимо ответить командой на сообщение с опросом (или использовать id опроса как аргумент)
